...
public class NationalParkController {
    ...
    private final NationalParkService nationalParkSevice;
    ...
    public String listAll(@RequestParam(required = false)String name,
                          ...
                          Model model) {
        model.addAttribute("parks", nationalParkSevice.findPage(name, areaSize, rating, parkType, locationId, pageNum - 1, pageSize));
        model.addAttribute("parkTypes", ParkType.values());
    ...
    public String showEdit(@PathVariable Long id, Model model) {
        model.addAttribute("park", nationalParkSevice.findById(id));
        model.addAttribute("parkTypes", ParkType.values());
        model.addAttribute("locations", parkLocationService.listAll());
        return "form";
    }
    ...
    public String create(@RequestParam(required = false) String name,
                         ...
                         @RequestParam(required = false) ParkType parkType,
                         @RequestParam(required = false) Long locationId) {
        nationalParkSevice.create(name, areaSize, rating, parkType, locationId);
    ...
    public String update(@PathVariable Long id,
                         ...
                         @RequestParam(required = false)ParkType parkType,
                         @RequestParam(required = false)Long locationId) {
        nationalParkSevice.update(id, name, areaSize, rating, parkType, locationId);
        return "redirect:/national-parks";
    }
