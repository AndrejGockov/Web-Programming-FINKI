...
public class ArchaeologicalSiteController {
    ...
    public String listAll(@RequestParam(required = false)String name,
                          ...
                          Model model) {
        model.addAttribute("archeologicalSites", archaeologicalSiteService.findPage(name, areaSize, rating, period, locationId, pageNum - 1, pageSize));
    ...
    public String showEdit(@PathVariable Long id, Model model) {
        model.addAttribute("archeologicalSite", archaeologicalSiteService.findById(id));
        model.addAttribute("siteLocations", siteLocationService.listAll());
        model.addAttribute("historicalPeriods", HistoricalPeriod.values());
        return "form";
    }
